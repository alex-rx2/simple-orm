 ...
 */
public class NamedIndexedQuery<P> extends BasicQuery<P, Seq<Object>> implements HasNamedInjector<P>, HasIndexedExtractor {
    ...
    public NamedIndexedQuery(QueryType queryType, String sql, int queryTimeoutSec,
                             NamedInjector<P> injector, IndexedExtractor extractor) {
